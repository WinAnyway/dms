...
public class JPAUserRepositoryTest {
    ...
    @Test
    public void shouldFindUserByEmployeeId() {
        //given
        User user = new User(new EmployeeId(1L), "janek", "xxx");
        jpaUserRepository.put(user);
    ...
    @Test
    public void shouldNotFindUserWhenEmployeeIdIsWrong() {
        //given
        User user = new User(new EmployeeId(1L), "janek", "xxx");
        jpaUserRepository.put(user);

        //then
        assertThat(jpaUserRepository.findByEmployeeId(new EmployeeId(2L))).isNull();
    }

    @Test
    public void shouldNotFindUserWhenUserNameIsWrong() {
        //given
        User user = new User(new EmployeeId(1L), "janek", "xxx");
        jpaUserRepository.put(user);

        //then
        assertThat(jpaUserRepository.findByUserName("franek")).isNull();
    }
